...
const _commandModule = _rewire('../../../src/commands/configure-host');

describe('[configure-host command]', () => {
    ...
    beforeEach(() => {
        ...
        _commandModule.__set__(
            'update_host_1',
            _taskMocks['update-host'].instance
        );
        _commandModule.__set__(
            'configure_nat_1',
    ...
    describe('[init]', () => {
        it('should export properties required by the command', () => {
            const expectedCommand = 'configure-host';
            const expectedDescription =
                "Configure remote host's software and network";
