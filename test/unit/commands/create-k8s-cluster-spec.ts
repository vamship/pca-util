...
const _commandModule = _rewire('../../../src/commands/create-k8s-cluster');

describe('[create-k8s-cluster command]', () => {
    ...
    describe('[init]', () => {
        it('should export properties required by the command', () => {
            const expectedCommand = 'create-k8s-cluster';
            const expectedDescription =
                'Create a kubernetes cluster on the remote host';
