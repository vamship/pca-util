...
const _taskModule = _rewire('../../../src/tasks/cleanup-template-environment');

describe('[cleanup-template-environment task]', () => {
    ...
    describe('getTask()', () => {
        const expectedTitle = 'Cleanup template build environment';
        const subTaskList = [
            {
